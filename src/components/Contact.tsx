          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-700 dark:text-gray-300">(11) 99999-9999</span>
              </div>
              <div className="flex items-center">
                <Mail className="w-5 h-5 text-rose-600 mr-3 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-300">desiree@lucchesi.com.br</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex space-x-4 mt-6">
                <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-rose-600 dark:hover:text-rose-500 transition-colors">
